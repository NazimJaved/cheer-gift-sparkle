      ...
      <section className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {courses.map((c) => (
            ...
            >
              <div className="relative flex aspect-video items-center justify-center bg-gradient-to-br from-teal/20 to-green/30">
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-4 flex flex-wrap gap-3 text-xs text-muted-foreground">
                  ...
                  <span className="inline-flex items-center gap-1"><PlayCircle className="h-3.5 w-3.5" /> {c.lessons} লেসন</span>
                  <span className="inline-flex items-center gap-1"><Award className="h-3.5 w-3.5" /> সার্টিফিকেট</span>
                </div>
                <div className="mt-5 flex items-center justify-between border-t border-border pt-4">
                  <span className="text-sm font-semibold text-green">{c.price}</span>
